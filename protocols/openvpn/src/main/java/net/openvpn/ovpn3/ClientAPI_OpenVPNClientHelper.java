...
public class ClientAPI_OpenVPNClientHelper {
  ...
  public static void setDco_incompatible_opts(SWIGTYPE_p_std__unordered_setT_std__string_t value) {
    ovpncliJNI.ClientAPI_OpenVPNClientHelper_dco_incompatible_opts_set(SWIGTYPE_p_std__unordered_setT_std__string_t.getCPtr(value));
  }

  public static SWIGTYPE_p_std__unordered_setT_std__string_t getDco_incompatible_opts() {
    long cPtr = ovpncliJNI.ClientAPI_OpenVPNClientHelper_dco_incompatible_opts_get();

package com.tim.vpnprotocols.xrayNeko.fmt.trojan_go
...
import com.tim.vpnprotocols.xrayNeko.parser.toStringPretty
import com.tim.vpnprotocols.xrayNeko.util.urlSafe
import com.tim.vpnprotocols.xrayNeko.fmt.LOCALHOST
    ...
    return JSONObject().apply {
       ...
       /* if (Protocols.shouldEnableMux("trojan-go")) put("mux", JSONObject().apply {
        ...
        put("tcp", JSONObject().apply {
            put("prefer_ipv4", true/*DataStore.ipv6Mode <= IPv6Mode.ENABLE*/)
        })

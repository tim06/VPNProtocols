...
import com.tim.vpnprotocols.xrayNeko.fmt.ConfigBean
import com.tim.vpnprotocols.xrayNeko.fmt.http.HttpBean
import com.tim.vpnprotocols.xrayNeko.fmt.hysteria.HysteriaBean
import com.tim.vpnprotocols.xrayNeko.fmt.hysteria.parseHysteria1Json
    ...
    suspend fun parseRaw(text: String, fileName: String = ""): List<AbstractBean>? {
        ...
        if (text.contains("proxies:")) {
            ...
            try {
                ...
                for (proxy in (yaml["proxies"] as? (List<Map<String, Any?>>) ?: error("no_proxies_found_in_file"))) {

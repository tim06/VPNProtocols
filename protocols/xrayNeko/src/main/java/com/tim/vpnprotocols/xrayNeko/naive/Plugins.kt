package com.tim.vpnprotocols.xrayNeko.naive
...
object Plugins {
    ...
    fun getPluginExternal(pluginId: String): ProviderInfo? {
        ...
        var providers = emptyList<ProviderInfo>()//getExtPluginOld(pluginId)

        // try PackageCache
        if (providers.isEmpty()) providers = emptyList<ProviderInfo>()// getExtPluginNew(pluginId)
